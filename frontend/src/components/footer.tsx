  ...
  return (
    <footer className="bg-violet-400 text-shadow-white z-50">
      <div className="max-w-7xl mx-auto px-6 py-12 grid gap-7 md:grid-cols-3">
        <div>
          <img src="/logo_white.svg" alt="Product Logo" className="w-30 h-auto" />
          <span className="text-xl md:text-2xl font-semibold tracking-tight text-white">  Is It Clear ?</span>
        </div>
